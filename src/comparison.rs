...
use crate::{
    ...
    measurement::{MeasurementSet, TrialResult},
};
...
impl ComparisonOutcome {
    ...
    pub(crate) fn report_path(&self) -> &std::path::Path {
        &self.output_path
    }

    pub(crate) fn report_data(&self) -> &ComparisonReport {
        &self.report
    }

    pub(crate) fn summary(&self) -> ComparisonSummary {
        ComparisonSummary {
...
pub(crate) struct ComparisonSummary {
    ...
    pub(crate) baseline_measurement_set: String,
    pub(crate) candidate_measurement_set: String,
    pub(crate) environment_fingerprint: Option<String>,
    pub(crate) policy: String,
    pub(crate) verdict: String,
    pub(crate) engines: Vec<EngineSummary>,
...
pub(crate) struct EngineSummary {
    ...
    pub(crate) anchor: Option<AnchorSummary>,
    pub(crate) metrics: BTreeMap<String, MetricSummary>,
}

#[derive(Clone, Debug, Deserialize, Serialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct AnchorSummary {
    pub(crate) status: String,
    pub(crate) drift_pct: Option<f64>,
...
pub(crate) struct MetricSummary {
    pub(crate) improvement_pct: Option<f64>,
    pub(crate) ci_pct: Option<[f64; 2]>,
    pub(crate) classification: String,
    pub(crate) guardrail_regressed: bool,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) baseline_value: Option<f64>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) candidate_value: Option<f64>,
}
